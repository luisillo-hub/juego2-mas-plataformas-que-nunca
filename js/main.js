...
LoadingState.preload = function () {
    ...
    this.game.load.spritesheet('hero1', 'images/hero1.png', 36, 42);
...
PlayState.create = function () {
    ...
    this.game.add.image(800, 0, 'background');
    this.game.add.image(-100, 220, 'background2');
    this.game.add.image(400, 220, 'background2');
    this.game.add.image(900, 220, 'background2');
    this.game.add.image(1100, 400, 'house');
    this.game.add.image(800, 100, 'clouds');
    this.game.add.image(200, 200, 'clouds');
    this.game.add.image(0, 50, 'clouds');
    this.game.add.image(900, 300, 'clouds');
...
PlayState._handleCollisions = function () {
    ...
    this.game.physics.arcade.collide(this.spiders, this.coins);
    this.game.physics.arcade.collide(this.platforms, this.coins);
   // this.game.physics.arcade.collide(this.enemyWalls, this.coins);
...
window.onload = function () {
    let game = new Phaser.Game(1300, 620, Phaser.AUTO, 'game');
